...
> 当前正式版：**v0.4.3** · 本地优先 · 无需注册 · 支持 macOS / Windows · 推荐 Chrome / Edge

[**下载 v0.4.3 软件包**](https://github.com/EnderRayven/NPEElearningtool/releases/download/v0.4.3/NPEE-Study-Space-v0.4.3-Software.zip) · [下载 v0.4.3 题库数据](https://github.com/EnderRayven/NPEElearningtool/releases/download/v0.4.3/NPEE-Study-Space-v0.4.3-Question-Bank.zip) · [查看 Release 说明](https://github.com/EnderRayven/NPEElearningtool/releases/tag/v0.4.3) · [反馈问题](https://github.com/EnderRayven/NPEElearningtool/issues)
...
1. 在同一个 [v0.4.3 Release](https://github.com/EnderRayven/NPEElearningtool/releases/tag/v0.4.3) 中分别下载 `NPEE-Study-Space-v0.4.3-Software.zip` 和 `NPEE-Study-Space-v0.4.3-Question-Bank.zip`。
